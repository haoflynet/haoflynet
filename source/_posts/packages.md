...
Docker引擎的API，通过它可以调用docker的命令，创建容器等强大的功能，比如`container_id = client.create_container('scrapinghub/splash', ports=[5023,8050,8051], host_config=client.create_host_config(port_bindings={5023:5023,8050:8050,8051:8051}), detach=True)`
...
由Python开发，django为框架的跨平台多语言/框架的日志聚合平台
